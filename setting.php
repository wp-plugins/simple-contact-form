...
?>
  ...
  <table width="100%" style="">
    <tr>
      <td align="left"><input name="text_management" lang="text_management" class="button-primary" onClick="location.href='options-general.php?page=simple-contact-form/simple-contact-form.php'" value="Go to - View contact details" type="button" />
  ...
  Go to widget menu and drag and drop the "Simple contact form" widget to your sidebar location.<br />
  ...
  <h2>Send Mails/Newsletters to those entered emails</h2>
  <p>Admin can send the Mails/Newsletters to those entered emails via my another famous plugin (<strong><a href="http://www.gopiplus.com/work/2010/09/25/email-newsletter/">Email newsletter plugin</a></strong>) </p>
  <h2>Plugin short code for pages/post</h2>
