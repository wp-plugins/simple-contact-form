  ...
  <li>Basic Settings
	...
	<div class="tutorial-true" style="margin: 5% auto;">
		...
		<h3 style="font-weight: normal; text-align: center;">Consider going premium to grow even faster!</h3>
			...
			<div class="save-changes" style="font-weight: normal; text-align: center;"><button type="submit" class="btn btn-large btn-warning save-next" formaction="<?php $current_url = explode("?", $_SERVER['REQUEST_URI']); echo $current_url[0];?>?page=readygraph-go-premium" style="margin: 15px">Learn more about Premium</button><br>
