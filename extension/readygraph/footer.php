	...
	$(function () {
		...
		$("a.monetize").click(function() {
			...
			, success: function (response) {
					...
					jQuery.post(ajaxurl,{action : 'gCF-myajax-submit',readygraph_monetize : "true",adsoptimal_id : monetize_adsoptimal_id, adsoptimal_secret : monetize_adsoptimal_secret},function() {});
		...
		$("a.connect").click(function() {
			...
			if (enable_monetize){
			$.post(ajaxurl,{action : 'gCF-myajax-submit',readygraph_monetize : "true"},function() {});
			var url = authHost + '/oauth/authenticate?client_id=' + settings.clientId + '&redirect_uri=' + encodeURIComponent(location.href.replace('#' + location.hash,"")) + '&response_type=token&monetization=true';
				...
				$.post(ajaxurl,{action : 'gCF-myajax-submit',readygraph_monetize : "false"},function() {});
