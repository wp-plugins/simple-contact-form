...
<div class="wrap">
<?php if( file_exists(plugin_dir_path( __FILE__ ).'/readygraph-extension.php' )) {wp_enqueue_style('ee_rg_admin_template', plugins_url() ."/simple-contact-form/extension/readygraph/assets/css/upgrade.css");
