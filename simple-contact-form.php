...
Description: Providing a Simple, Super, Security and Ajax based contact form on your wordpress site.
Author: Gopi.R
Version: 3.0
...
function gCF()
{
	...
	if($display == "show")
	{
		...
		<form action="#" name="gcf" id="gcf">
		  ...
		  <div style='padding-top:4px;' class="gcf_title"> Your email </div>
		  <div>
			<input name="gcf_email" class="gcftextbox" type="text" id="gcf_email" maxlength="120">
		  </div>
		  <div style='padding-top:4px;' class="gcf_title"> Enter your message </div>
		  <div>
...
<div class="wrap">
  <div class="tool-box">
	...
	if ( empty($data) ) 
	{ 
		echo "<div id='message' class='error'><p>No data available. Go to front end and post one sample data using contact form.</p></div>";
		return;
	}
	...
	<a href="options-general.php?page=simple-contact-form/simple-contact-form.php">Manage Page</a> 
	<a href="options-general.php?page=simple-contact-form/setting.php">Setting Page</a> 
	</div>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
	  <tr>
		...
		<h2><?php echo wp_specialchars( 'About plugin!' ); ?></h2>
		  ...
		  <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/16/simple-contact-form/'>click here</a> to post suggestion or comments or how to improve this plugin.<br>
		  <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/16/simple-contact-form/'>click here</a> to see my plugin demo.<br>
		  <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/08/16/simple-contact-form/'>click here</a> To download my other plugins.<br>
		...
		<td><?php if (function_exists (timepass)) timepass();?></td>
	  </tr>
	</table>
  </div>
</div>
