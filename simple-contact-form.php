  ...
  <div class="tool-box">
    ...
    <table width="100%" style="padding-bottom:10px;padding-top:10px;">
      <tr>
		...
		<input name="Help" lang="publish" class="button-primary" onclick="window.open('http://www.gopipulse.com/work/2010/07/18/simple-contact-form/');" value="Help" type="button" />
		</td>
      </tr>
    </table>
    ...
    <strong>Send Mails/Newsletters to above contact emails</strong>
  		<p>Admin can send the HTML Mails/Newsletters to those emails via my another famous plugin (<strong><a target="_blank" href="http://www.gopipulse.com/work/2010/09/25/email-newsletter/">Email newsletter plugin</a></strong>) </p>
